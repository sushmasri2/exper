...
export default function CourseSettings({ courseData }: CourseSettingsProps) {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const [categoriesData, courseTypesData, eligibilitiesData, coursesData, instructorsData, specialitiesData, accreditationPartnersData] = await Promise.all([
                    getCoursesCategory(),
                    getCoursesType(),
                    getEligibilities(),
                    ...
                    getAccreditationPartners().catch((err) => {
                ...
                // Set Accreditation Partners options for Select2
                ...
                if (courseData) {
                    ...
                    if (courseData.uuid) {
                        try {
                                ...
                                if (settings) {
                                    ...
                                    setFormData(prev => {
                                        ...
                                        return {
                                            ...
                                            speciality_type: typeof settings.speciality_type === "string" ? settings.speciality_type : prev.speciality_type,
                                        };
                                    });
                                }
                            } catch (err) {
                            ...
                            // Fetch selected accreditation partners for this course
                            try {
                                const courseAccreditationPartners = await getCourseAccreditationPartners(courseData.uuid);
                        ...
                        <div className="grid grid-cols-3 gap-4 mb-4">
                            ...
                            <div>
                                ...
                                <Select2
                                    ...
                                    onChange={val => {
                                        if (typeof val === 'string') {
                                            handleInputChange('speciality_type', val);
                                        }
                                    }}
